...
const Footer = () => {
  ...
  const [showmetamuse, setshowmetamuse] = useState(false)
  const onClickMetaMuse=(e)=>{
    e.preventDefault();
    setshowmetamuse((showmetamuse)=>{
      return !showmetamuse;
    })
  }

  const [showquickLinks, setshowquickLinks] = useState(false)
  const onClickQuickLinks=(e)=>{
    e.preventDefault();
    ...
    <div className={style.footer}>
      <div className={style.footerSection}>
        <div className={style.footerSectionContent}>
          ...
          <div className={style.footerSection_group}>
            <h1 className={style.subheading}>Be the first to know</h1>
            <p>Sign Up for updates</p>
          </div>
          <div className={style.getSubsciption}>
            <input placeholder="Enter your email"></input>
            <button className={style.subscriptionButton}>Subsrcibe</button>
          </div>
        </div>
        <div className={style.footerSectionContact}>
        
          <div className={style.contactDetails}>
            <h2 className={style.subheading}>Contact Us</h2>
          ...
          <div className={style.contactDetails}>
            <h2 className={style.subheading}>Currency</h2>
            <p className={style.currency}>
              ...
              >
                <g clip-path="url(#clip0_20791_289)">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
           ...
           {
            isMobile?<></>:<span className={style.paymentDisclaimer}>
      ...
      <div className={style.footerSectionLinks}>
        <div className={style.pageLinks}>
          {/* meta muse */}
          <span className={style.dropdownfooter} onClick={onClickMetaMuse}>
            <p className={style.subheading}>metta muse</p>
           {
            isMobile?(<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.4001 7.4248L8.83343 12.8581C9.4751 13.4998 10.5251 13.4998 11.1668 12.8581L16.6001 7.4248" stroke="white" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>):(<></>)
           } 

          </span>
        
          {isMobile ?( showmetamuse && <ul className={style.pageLinks}>
            <li>About Us</li>
            <li>Stories</li>
            <li>Artisans</li>
            <li>Boutique</li>
          ...
          </ul>):(<ul className={style.pageLinks}>
            <li>About Us</li>
            <li>Stories</li>
            <li>Artisans</li>
            <li>Boutique</li>
        ...
        <div className={style.pageLinks}>
          ...
          <span className={style.dropdownfooter} onClick={onClickQuickLinks}>
            <p className={style.subheading}>Quick Links</p>
           {
            isMobile?(<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.4001 7.4248L8.83343 12.8581C9.4751 13.4998 10.5251 13.4998 11.1668 12.8581L16.6001 7.4248" stroke="white" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>):(<></>)
          ...
          {isMobile ?( showquickLinks && <ul className={style.pageLinks}>
            <li>Order & Shipping</li>
            <li>Join/Login as a Sellar</li>
        ...
        <div className={style.footerSocialMedia}>
          ...
          <div>
            <span className={style.footerfollow} onClick={onClickshowFollow}>
                <p className={style.subheading}>Follow Us</p>
                {
            isMobile?(<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.4001 7.4248L8.83343 12.8581C9.4751 13.4998 10.5251 13.4998 11.1668 12.8581L16.6001 7.4248" stroke="white" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>):(<></>)
            ...
            >
              <rect
                ...
                stroke-width="1.2"
              />
              <g clip-path="url(#clip0_20791_242)">
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
          ...
          <div>
            ...
            <span className={style.footerfollow} onClick={onClickshowPayments}>
               <p className={style.subheading}>meta musse accepts</p>
               {
            isMobile?(<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.4001 7.4248L8.83343 12.8581C9.4751 13.4998 10.5251 13.4998 11.1668 12.8581L16.6001 7.4248" stroke="white" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>):(<></>)
            ...
            {isMobile ?( showPayments &&     <div>
              <Image src={"/paymenticons/gpay.png"} width={30} height={20} />
              <Image src={"/paymenticons/visa.png"} width={30} height={20} />
              <Image src={"/paymenticons/paypal.png"} width={30} height={20} />
              <Image
                src={"/paymenticons/applepay.png"}
                width={30}
                height={20}
              />
              <Image
                ...
                height={20}
              />
              <Image src={"/paymenticons/pay.png"} width={30} height={20} />
            </div>):(    <div>
              <Image src={"/paymenticons/gpay.png"} width={30} height={20} />
              <Image src={"/paymenticons/visa.png"} width={30} height={20} />
              <Image src={"/paymenticons/paypal.png"} width={30} height={20} />
